/*
 ...
 ======================================================================== */
+function(a){var c=function(b){a(b).on("click",'[data-dismiss="alert"]',this.close)};c.VERSION="3.3.6";c.TRANSITION_DURATION=150;c.prototype.close=function(b){function f(){d.detach().trigger("closed.bs.alert").remove()}var e=a(this),g=e.attr("data-target");g||(g=(g=e.attr("href"))&&g.replace(/.*(?=#[^\s]*$)/,""));var d=a(g);b&&b.preventDefault();d.length||(d=e.closest(".alert"));d.trigger(b=a.Event("close.bs.alert"));b.isDefaultPrevented()||(d.removeClass("in"),a.support.transition&&d.hasClass("fade")?
