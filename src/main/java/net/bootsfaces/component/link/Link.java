...
public class Link extends NavLink implements IAJAXComponent2 {
	...
	/**
	 * content-class is optional: if specified, the content (i.e. the anchor tag)
	...
	/**
	 * Navigation Link Icon, can be one of the Bootstrap's Glyphicons icon names.
	...
	/**
	 * Navigation Link Font Awesome Icon, can be one of the Font Awesome icon names.
	 * Alignment can be specified with the icon-align attribute.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	...
	/**
	 * Client side callback to execute when input element loses focus and its value
	...
	/**
	 * Client side callback to execute when a key is pressed and released over input
	 * element.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	...
	/**
	 * Client side callback to execute when text within input element is selected by
	 * user.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	...
	/**
	 * Position of this element in the tabbing order for the current document. This
	...
	/**
	 * Optional target of the HTML anchor tag that's rendered. E.g. # opens the link
	 * in a new tab. This attribute is only evaluated if you provide an href.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	 *         the JSF file.
