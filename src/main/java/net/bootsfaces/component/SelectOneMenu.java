...
public class SelectOneMenu extends HtmlInputText {
    ...
    public void decode(FacesContext context) {
        ...
        List<Object> items = collectOptions(context);
        ...
        if (null != submittedOptionValue) {
            for (int index = 0; index < items.size(); index++) {
                ...
                if (submittedOptionValue.equals(currentOptionValueAsString)) {
                    this.setSubmittedValue(currentOptionValue);
                    this.setValid(true);
                    return;
                }
            }
        ...
        this.setSubmittedValue(submittedOptionValue);
        this.setValid(true);
    }
    ...
    protected void addAppendingAddOnToInputGroup(FacesContext context, ResponseWriter rw,
            UIComponent appendingAddOnFacet, boolean hasAppendingAddOn) throws IOException {
    ...
    protected void addPrependingAddOnToInputGroup(FacesContext context, ResponseWriter rw,
            UIComponent prependingAddOnFacet, boolean hasPrependingAddOn) throws IOException {
    ...
    public Object getValue2Render(FacesContext context) {
        Object sv = this.getSubmittedValue();
        if (sv != null) {
            return sv;
        }
    ...
    protected void renderSelectTag(FacesContext context, Map<String, Object> attrs, ResponseWriter rw, String clientId)
            throws IOException {
        renderSelectTag(rw);
        renderSelectTagAttributes(attrs, rw, clientId);
        Object selectedOption = getValue2Render(context);
     ...
     * @throws IOException
     */
    protected void renderOptions(FacesContext context, ResponseWriter rw, Object selectedOption) throws IOException {
        List<Object> items = collectOptions(context);
    ...
    private List<Object> collectOptions(FacesContext context) {
