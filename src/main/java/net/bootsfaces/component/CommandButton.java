...
public class CommandButton extends HtmlCommandButton {
	...
	public void encodeEnd(FacesContext context) throws IOException {
		...
		/*
		 * <button class="btn btn-large" href="#"><i class="icon-star"></i>
		 * Star</button>
		 */
		attrs = getAttributes();
		encodeHTML(context);
	...
	public void encodeHTML(FacesContext context) throws IOException {
		...
		generateOnClickHandler(context, rw, CID, type, A.toBool(attrs.get(A.AJAX), false));
	...
	private void generateOnClickHandler(FacesContext context, ResponseWriter rw, String CID, String type, boolean ajax)
			throws IOException {
		...
		if (!type.equals(A.RESET) && !type.equals(A.BUTTON)) {
			...
			if (ajax) {
				...
				cJS = new StringBuilder(encodeClick());// Fix
