/**
 *  Copyright 2014-2017 by Riccardo Massera (TheCoder4.Eu), Dario D'Urzo and Stephan Rauh (http://www.beyondjava.net).
 *
...
public abstract class SpinnerCore extends IconAwesome implements net.bootsfaces.render.IHasTooltip {
	...
	/**
	 * Icon name: default 'circle-o-notch'. <P>
	 * @return Returns the value of the attribute, or "circle-o-notch", if it hasn't been set by the JSF file.
	 */
	public String getName() {
		return (String) getStateHelper().eval(PropertyKeys.name, "circle-o-notch");
	}
