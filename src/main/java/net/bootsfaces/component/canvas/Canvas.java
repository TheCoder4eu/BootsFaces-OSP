...
public class Canvas extends UIOutput implements net.bootsfaces.render.IHasTooltip {
	...
	/**
	 * Height of the canvas in pixels. This is a mandatory field.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been
	 *         set by the JSF file.
	...
	public int getHeight() {
		Integer value = (Integer) getStateHelper().eval(PropertyKeys.height, 600);
		return (int) value;
	}
	...
	/**
	 * Optional description what to draw on this component.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been
	 *         set by the JSF file.
	...
	public Drawing getDrawing() {
		Drawing value = (Drawing) getStateHelper().eval(PropertyKeys.drawing);
		return value;
	}
	...
	/**
	 * Width of the canvas in pixels. This is a mandatory field.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been
	 *         set by the JSF file.
	 */
	public int getWidth() {
		Integer value = (Integer) getStateHelper().eval(PropertyKeys.width, 600);
		return (int) value;
	}
