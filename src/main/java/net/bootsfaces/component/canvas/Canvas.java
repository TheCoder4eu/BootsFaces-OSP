...
public class Canvas extends UIOutput implements net.bootsfaces.render.IHasTooltip, IResponsive {
	...
	protected enum PropertyKeys {
		autoUpdate, binding, colLg, colMd, colSm, colXs, display, drawing, height, hidden, largeScreen, mediumScreen, offset, offsetLg, offsetMd, offsetSm, offsetXs, smallScreen, span, style, styleClass, tinyScreen, tooltip, tooltipContainer, tooltipDelay, tooltipDelayHide, tooltipDelayShow, tooltipPosition, visible, width;
		String toString;
	 ...
	 * @return Returns the value of the attribute, or 600, if it hasn't been set by the JSF file.
	 */
