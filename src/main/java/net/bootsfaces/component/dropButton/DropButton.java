...
public class DropButton extends UIComponentBase implements IHasTooltip, IResponsive, IContentDisabled {
	...
	/**
	 * Look of the Button, can be primary, info, success, warning, danger. If not
	 * specified, a standard gray button will be rendered.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	 *         the JSF file.
	...
	/**
	 * The size of the Button.Possible values are xs (extra small), sm (small), md
	 * (medium) and lg (large) .
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
