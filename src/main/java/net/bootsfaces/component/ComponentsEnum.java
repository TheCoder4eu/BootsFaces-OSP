...
public enum ComponentsEnum {
	...
	dateTimePicker("<b:dateTimePicker", "dateTimePicker"),
	...
	focus("<b:focus", "focus"),
	fullCalendar("<b:fullCalendar", "fullCalendar"),
	growl("<b:growl", "growl"),
	...
	pillLinks("<b:pillLinks", "pillLinks"),
	poll("<b:poll", "poll"),
	progressBar("<b:progressBar", "progressBar"),
	radiobutton("<b:radiobutton", "radiobutton"),
	remoteCommand("<b:remoteCommand", "remoteCommand"),
	row("<b:row", "row"),
	...
	touchSpin("<b:touchSpin", "touchSpin"),
	tab("<b:tab", "tab"),
