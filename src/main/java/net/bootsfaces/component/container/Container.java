...
@FacesComponent(Container.COMPONENT_TYPE)
public class Container extends UIOutput implements net.bootsfaces.render.IHasTooltip, IContentDisabled {

	public static final String COMPONENT_TYPE = C.BSFCOMPONENT + ".container.Container";
	...
	protected enum PropertyKeys {
		autoUpdate, contentDisabled, dir, fluid, style, styleClass, tooltip, tooltipContainer, tooltipDelay, tooltipDelayHide, tooltipDelayShow, tooltipPosition;
		String toString;
	...
	/**
	 * Boolean value default is false; when set to true, the container will be "fluid": a full width container, spanning the entire width of the viewport. <P>
	 * @return Returns the value of the attribute, or , false, if it hasn't been set by the JSF file.
	 */
