...
public class Button extends HtmlOutcomeTargetButton implements net.bootsfaces.render.IHasTooltip {
	...
	/**
	 * This attribute is mapped to the HTML5 data-dismiss custom attribute.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been
	 *         set by the JSF file.
	 ...
	 * specified with icon-align attribute.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been
	 *         set by the JSF file.
	...
	/**
	 * Font Awesome Icon to show in this Button, can be one of the Font Awesome
	 * icon names. Alignment can be specified with the icon-align attribute.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been
	 *         set by the JSF file.
	 ...
	 * important, error, inverse. If not specified, Standard gray button with
