...
public class NavBarRenderer extends CoreRenderer {
	...
	* to generate the rest of the HTML code.
	...
	public void encodeBegin(FacesContext context, UIComponent component) throws IOException {
		...
		rw.startElement("span", navBar);rw.writeAttribute("class", "sr-only","class");rw.writeText("Toggle navigation", null);rw.endElement("span");
		rw.startElement("span", navBar);rw.writeAttribute("class", "icon-bar","class");rw.endElement("span");
		rw.startElement("span", navBar);rw.writeAttribute("class", "icon-bar","class");rw.endElement("span");
		rw.startElement("span", navBar);rw.writeAttribute("class", "icon-bar","class");rw.endElement("span");
		...
		if(brand!=null || brandImg!=null) {
			...
			else           { rw.writeAttribute("href", href,"href"); }
