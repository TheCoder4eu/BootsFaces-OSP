...
public class ColorPicker extends HtmlInputText implements IHasTooltip, IAJAXComponent {
	...
	/**
	 * The type of control to display. Valid values: hue, brightness,
	...
	/**
	 * Type of returned data. Valid values: hex and rgb.
	 * <P>
	 *
	 * @return Returns the value of the attribute, or null, if it hasn't been
	 *         set by the JSF file.
	...
	/**
	 * True to enable opacity swatches.
	 * <P>
	 *
	 * @return Returns the value of the attribute, or null, if it hasn't been
	 *         set by the JSF file.
	...
	/**
	 * Sets the position of the dropdown. Valid options are bottom left, bottom
	 * right, top left, and top right.
	 * <P>
	 *
	 * @return Returns the value of the attribute, or null, if it hasn't been
	 *         set by the JSF file.
