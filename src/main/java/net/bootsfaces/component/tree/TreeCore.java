...
public abstract class TreeCore extends UIComponentBase {
     ...
     * <P>
     * @return Returns the value of the attribute, or "#DDDDDD", if it hasn't
     * been set by the JSF file.
     */
     ...
     * <P>
     * @return Returns the value of the attribute, or "-1", if it hasn't been
     * set by the JSF file.
     */
     ...
     * <P>
     * @return Returns the value of the attribute, or "block", if it hasn't been
     * set by the JSF file.
     */
    ...
    /**
     * Boolean value to specify if enable href link.
     * <P>
     ...
     * <P>
     * @return Returns the value of the attribute, or true, if it hasn't been
     * set by the JSF file.
     */
    ...
    /**
     * Tree model value. Requires a
     * java.util.List&lt;net.bootsfaces.component.tree.model.Node&gt; to work.
     * <P>
     * @return Returns the value of the attribute, or null, if it hasn't been
     * set by the JSF file.
     */
