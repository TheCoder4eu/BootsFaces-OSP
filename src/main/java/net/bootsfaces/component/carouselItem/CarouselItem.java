...
public class CarouselItem extends UICommand
	...
	/**
	 * Optional attribute to define which slide is active initially.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been
	 *         set by the JSF file.
	...
	/**
	 * Optional caption, which is embedded in an h3 tag. If you need more
	 * flexibility, add an carouselCaption child tag. If you don't need a
	 * caption, omit both.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been
