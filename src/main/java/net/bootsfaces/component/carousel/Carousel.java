...
public class Carousel extends UICommand
	 ...
	 * pointer enters the carousel, and resumes the sliding when the mouse
	 * pointer leaves the carousel. Set pause to false to stop the ability to
	 * pause on hover.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been
	...
	/**
	 * Specifies whether the carousel should go through all slides continuously,
	 * or stop at the last slide.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been
	 *         set by the JSF file.
	...
	/**
	 * Client side callback to execute when the carousel start to slide to
	 * another item.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been
	...
	/**
	 * Client side callback to execute when the carousel just finished sliding
	 * to another item.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been
	...
	/**
	 * Tells Bootstrap to show new items by sliding them into view
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been
	 *         set by the JSF file.
	...
	/**
	 * tells Bootstrap to begin animating the carousel immediately when the page
	 * loads.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been
	...
	/**
	 * adds 'left' and 'right' buttons that allows the user to go back and forth
	 * between the slides manually
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been
	 *         set by the JSF file.
	...
	/**
	 * The indicators are the little dots at the bottom of each slide (which
	 * indicates how many slides there are in the carousel, and which slide the
