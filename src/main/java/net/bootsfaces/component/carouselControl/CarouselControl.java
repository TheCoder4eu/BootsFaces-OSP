...
@FacesComponent(CarouselControl.COMPONENT_TYPE)
public class CarouselControl extends UICommand
		implements net.bootsfaces.render.IHasTooltip, IAJAXComponent, IAJAXComponent2, ClientBehaviorHolder {

	public static final String COMPONENT_TYPE = C.BSFCOMPONENT + ".carouselControl.CarouselControl";
	...
	protected enum PropertyKeys {
		ajax, delay, direction, disabled, onclick, oncomplete, ondblclick, onerror, onmousedown, onmousemove, onmouseout, onmouseover, onmouseup, onsuccess, process, style, styleClass, tooltip, tooltipContainer, tooltipDelay, tooltipDelayHide, tooltipDelayShow, tooltipPosition, update;
		String toString;
	...
	/**
	 * Can take one of the values 'left' and 'right'. Determines whether the carousel scrolls to the next or to the previous image. <P>
	 * @return Returns the value of the attribute, or null, if it hasn't been set by the JSF file.
	 */
