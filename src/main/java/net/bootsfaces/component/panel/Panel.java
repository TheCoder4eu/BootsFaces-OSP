...
public class Panel extends UIComponentBase implements net.bootsfaces.render.IHasTooltip, IAJAXComponent,
	...
	/**
	 * An EL expression referring to a server side UIComponent instance in a backing
	 * bean.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	 ...
	 * pixels wide). The number may optionally be followed by "column" or "columns".
	...
	/**
	 * content-class is optional: if specified, the content will be displayed with
	 * this specific class
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	...
	/**
	 * Enables or disables every child element of this container. By default, child
	 ...
	 * values: ltr (Default. Left-to-right text direction), rtl (Right-to-left text
	 * direction) and auto (let the browser figure out the direction of your
	 * alphabet, based on the page content).
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	 *         the JSF file.
	 ...
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or "block", if it hasn't been set
	 *         by the JSF file.
	 */
	...
	/**
	 * This column is hidden on a certain screen size and below. Legal values: lg,
	 * md, sm, xs.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	...
	/**
	 * Panel header icon, can be one of the Bootstrap's Glyphicons icon names.
	 * Alignment can be specified with the icon-align attribute.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	 *         the JSF file.
	...
	/**
	 * Font Awesome icon to show in this Panel header, can be one of the Font
	 * Awesome icon names. Alignment can be specified with the icon-align attribute.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	 *         the JSF file.
	...
	/**
	 * Use the free brand font of FontAwesome 5. As a side effect, every FontAwesome
	 * icon on the same page is switched to FontAwesome 5.2.0. By default, the icon
	 * set is the older version 4.7.0.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or , false, if it hasn't been set
	 *         by the JSF file.
	...
	/**
	 * Use the paid 'light' font of FontAwesome 5. As a side effect, every
	 * FontAwesome icon on the same page is switched to FontAwesome 5.2.0. By
	 * default, the icon set is the older version 4.7.0.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or , false, if it hasn't been set
	 *         by the JSF file.
	...
	/**
	 * Use the paid 'regular' font of FontAwesome 5. As a side effect, every
	 * FontAwesome icon on the same page is switched to FontAwesome 5.2.0. By
	 * default, the icon set is the older version 4.7.0.
	 * <P>
	 * 
	...
	/**
	 * Icon Size: legal values are lg (=133%), 2x, 3x, 4x, 5x. If you're using
	 * Fontawesome 5, also 6x, 7x, 8x, 9, 10x, xs (=75%), and sm (=87.5%) are
	 * allowed.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	...
	/**
	 * Use the free font of FontAwesome 5. As a side effect, every FontAwesome icon
	 * on the same page is switched to FontAwesome 5.2.0. By default, the icon set
	 * is the older version 4.7.0.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or , false, if it hasn't been set
	 *         by the JSF file.
	 ...
	 * immediately (that is, during Apply Request Values phase) rather than waiting
	 * until Invoke Application phase. Default is false.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or , false, if it hasn't been set
	 *         by the JSF file.
	...
	/**
	 * Alternative spelling to col-lg. Integer value to specify how many columns to
	 * span on large screens (≥1200 pixels wide). The number may optionally be
	 * followed by "column" or "columns". Alternative legal values: half, one-third,
	 * two-thirds, one-fourth, three-fourths.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or "-1", if it hasn't been set by
	 *         the JSF file.
	...
	/**
	 * Look of the Panel, can be primary, success, info, warning, danger. Default is
	 * warning.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	...
	/**
	 * Alternative spelling to col-md. Integer value to specify how many columns to
	 * span on medium screens (≥992 pixels wide). The number may optionally be
	 * followed by "column" or "columns". Alternative legal values: half, one-third,
	 * two-thirds, one-fourth, three-fourths.
	 * <P>
	 * 
	...
	/**
	 * JavaScript to be executed when ajax results on an error (including both
	 * network errors and Java exceptions).
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	 *         the JSF file.
	...
	/**
	 * Client side callback to execute when a pointer input element is pressed down
	 * over input element.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	...
	/**
	 * Client side callback to execute when a pointer input element is moved within
	 * input element.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	...
	/**
	 * Client side callback to execute when a pointer input element is moved away
	 * from input element.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	...
	/**
	 * Client side callback to execute when a pointer input element is moved onto
	 * input element.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	...
	/**
	 * Client side callback to execute when a pointer input element is released over
	 * input element.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	...
	/**
	 * JavaScript to be executed when ajax completes with success (i.e. there's
	 * neither a network error nor a Java exception).
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	 *         the JSF file.
	...
	/**
	 * Collapsible panel headers are decorated by an underline to indicate it can be
	 * toggled using the keyboard if you activate this feature by setting
	...
	/**
	 * Alternative spelling to col-sm. Integer value to specify how many columns to
	 * span on small screens (≥768p pixels wide). The number may optionally be
	 * followed by "column" or "columns". Alternative legal values: half, one-third,
	 * two-thirds, one-fourth, three-fourths.
	 * <P>
	 * 
	...
	/**
	 * Alternative spelling to col-xs. Integer value to specify how many columns to
	 * span on tiny screens (≤ 767 pixels wide). The number may optionally be
	 * followed by "column" or "columns". Alternative legal values: half, one-third,
	 * two-thirds, one-fourth, three-fourths.
	 * <P>
	 * 
	...
	/**
	 * Title is optional: if specified, the heading facet will not be rendered and
	 * the panel will render with a heading with this Title.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	 *         the JSF file.
	...
	/**
	 * TitleClass is optional: if specified, the title will be displayed with this
	 * specific class
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	...
	/**
	 * Where is the tooltip div generated? That's primarily a technical value that
	 * can be used to fix rendering errors in special cases. Also see data-container
	 * in the documentation of Bootstrap. The default value is body.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or "body", if it hasn't been set
	 *         by the JSF file.
	 */
	...
	/**
	 * The tooltip is hidden with a delay. This value is the delay in milliseconds.
	...
	/**
	 * The tooltip is shown with a delay. This value is the delay in milliseconds.
	 * Defaults to 0 (no delay).
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or 0, if it hasn't been set by
	 ...
	 * "right", "left", "auto", "auto top", "auto bottom", "auto right" and "auto
	 * left". Default to "bottom".
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
	 *         the JSF file.
	...
	/**
	 * This column is shown on a certain screen size and above. Legal values: lg,
	 * md, sm, xs.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been set by
