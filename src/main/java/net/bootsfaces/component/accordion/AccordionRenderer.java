...
public class AccordionRenderer extends CoreRenderer {
	...
	/**
	 * Override encodeChildren because the children rendering is driven by
	 * the custom encode of accordion component
	 */
	@Override
	...
	* to generate the rest of the HTML code.
	 ...
	 * @param component the current b:accordion.
	...
	public void encodeBegin(FacesContext context, UIComponent component) throws IOException {
		...
		List<String> expandedIds = (null != accordion.getExpandedPanels()) ? Arrays.asList(accordion.getExpandedPanels().split(",")) : null;
