...
public class SelectMultiMenu extends HtmlInputText implements net.bootsfaces.render.IHasTooltip {
	...
	/**
	 * HTML snippet of the container holding both the button as well as the
	 * dropdown. Default: <div class='btn-group' style='display:block'></div>.
	 * Note that the original definition of the widget doesn't use the style
	 * definition. We've added it to fix a rendering bug.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been
	 *         set by the JSF file.
	...
	/**
	 * Text which is displayed if more than numberDisplayed options have been
	 * selected.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been
	...
	/**
	 * Set to true or false to enable or disable the filter. A filter input will
	 * be added to dynamically filter all options.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been
	 *         set by the JSF file.
	...
	/**
	 * Set to true to display radiobuttons instead of checkboxes. Of course, in
	 * this case you can only select one option, so the widget's name is sort of
	 * a misnomer.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been
	...
	/**
	 * Style class of the input element. Is translated to the buttonContainer
	 * attribute.
	 * <P>
	 * 
	 * @return Returns the value of the attribute, or null, if it hasn't been
