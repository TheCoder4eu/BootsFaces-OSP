...
public class SelectMultiMenuRenderer extends CoreRenderer {
     ...
     *             may be thrown by the response writer
     */
    protected void addLabel(Map<String, Object> attrs, ResponseWriter rw, String clientId, SelectMultiMenu menu) throws IOException {
    ...
    protected void renderSelectTag(FacesContext context, Map<String, Object> attrs, ResponseWriter rw, String clientId, SelectMultiMenu menu)
            throws IOException {
     ...
     * @throws IOException
     */
    protected void renderOptions(FacesContext context, ResponseWriter rw, Object selectedOption, SelectMultiMenu menu) throws IOException {
        List<Object> items = collectOptions(context, menu);
     ...
     *             may be thrown by the response writer
     */
    protected int startColSpanDiv(Map<String, Object> attrs, ResponseWriter rw, SelectMultiMenu menu) throws IOException {
     ...
     *             may be thrown by the response writer
     */
    protected boolean startInputGroupForAddOn(ResponseWriter rw, boolean hasPrependingAddOn, boolean hasAppendingAddOn, SelectMultiMenu menu)
            throws IOException {
