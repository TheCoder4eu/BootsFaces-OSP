...
/**
 * This class adds the resource needed by BootsFaces and ensures that they are loaded in the correct order. It replaces the former
 * HeadListener.
 * 
 * @author Stephan Rauh
 */
public class AddResourcesListener implements SystemEventListener {
     ...
     * @param isProduction
     *            This flag can be used to deliver different version of the JS library, optimized for debugging or production.
     */
    ...
    /**
     * Look whether a b:iconAwesome component is used. If so, the font-awesome.css is removed from the resource list because it's loaded
     * from the CDN.
     * 
