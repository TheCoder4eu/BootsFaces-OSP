...
public class InputTextRenderer extends CoreRenderer {
	 ...
	 public void encodeEnd(FacesContext context, UIComponent component) throws IOException {
	        ...
	        if(prepend) { R.addClass2FacetComponent(prep, "OutputText", inputText.ADDON); }//(prep.getChildren(), "OutputText", S.ADDON); }
	        if(append) { R.addClass2FacetComponent(app, "OutputText", inputText.ADDON); }
	        ...
	        s=sb.toString().trim();
	        if(s!=null && s.length()>0) { rw.writeAttribute(H.CLASS, s, H.STYLECLASS); }
	        ...
	        for (String keyClientBehavior : keysClientBehavior){
	        	...
	        	for (ClientBehavior cb : behaviors){
	            	ClientBehaviorContext behaviorContext = ClientBehaviorContext.createClientBehaviorContext(context,inputText,keyClientBehavior, null, null);
