...
public class DatePicker extends HtmlInputText {
    ...
    protected Object getConvertedValue(FacesContext fc, Object sval) throws ConverterException {
        ...
        try {
            ...
            date = format.parse(val); ((Date) date).setHours(12);
            
        } 
        catch (ParseException e) {
            this.setValid(false);
            throw new ConverterException(
                    MessageFactory.getMessage("javax.faces.converter.DateTimeConverter.DATE", FacesMessage.SEVERITY_ERROR,
                                              new Object[] { val, sdf, MessageFactory.getLabel(fc, this) })
                    );
        }
    ...
    public void encodeBegin(FacesContext fc) throws IOException {
        /*
         * Popup
         * <input id="form:popCal" name="form:popCal" type="text" />
         * <script id="form:popCal_js" type="text/javascript">
         * $(function(){
         *   $('form:popCal').datepicker({id:'form:popupCal',popup:true,locale:'en_US',dateFormat:'m/d/y'});
         * });
         * </script>
         * 
         * Inline
         * Adds a Div and Uses a Hidden Input
         */
    ...
    private void encodeHTML(FacesContext fc) throws IOException {
        ...
        if(v!=null) { rw.writeAttribute(H.VALUE, getDateAsString(v,sdf, sloc), null); }
        ...
        if (mode.equals(A.POPICON)||mode.equals(A.TOGGLEICON)) { R.addonIcon(rw, this, CALENDAR, false); }
    ...
    /*public static TimeZone selectTimeZone(Object utz) {
        java.util.TimeZone selTimeZone;
        if (utz != null) {
            if (utz instanceof String) {
                selTimeZone = java.util.TimeZone.getTimeZone((String) utz);
            } else if (utz instanceof java.util.TimeZone) {
                selTimeZone = (java.util.TimeZone) utz;
            } else {
                throw new IllegalArgumentException("TimeZone should be either String or java.util.TimeZone");
            }
        } else {
            selTimeZone = java.util.TimeZone.getDefault();
        }
        return selTimeZone;
    }*/
    ...
    public Locale selectLocale(Locale vrloc, Object loc) {
        ...
        if (loc != null) {
            if (loc instanceof String) {
                ...
                throw new IllegalArgumentException("Type:" + loc.getClass() + " is not a valid locale type for DatePicker:" + this.getClientId());
            }
        }
    ...
    * 
    * @param locale Locale (may be the result of a call to selectLocale)
    ...
    */
    public static String selectDateFormat(Locale locale, String format) {
        ...
        if (format == null) {
            ...
            if(selFormat.equals("M/d/yy")) { return "MM/dd/yyyy"; }
            if(selFormat.equals("d/M/yy")) { return "dd/MM/yyyy"; }
        } else {
            selFormat = format;
        }
    ...
    * 
    * @param format Format to be converted
